...
var create = function create(text, options) {
  ...
  if (!document.getElementById('ct-container')) {
    ...
    document.body.appendChild(getDOMNodeFromReact(React.createElement("div", {
      id: "ct-container",
  ...
  var toastNode = getDOMNodeFromReact(React.createElement("div", {
    className: toastClass,
    style: toastStyle
  }, icon || (type !== 'loading' ? React.createElement(CurrentIcon, null) : React.createElement("div", {
